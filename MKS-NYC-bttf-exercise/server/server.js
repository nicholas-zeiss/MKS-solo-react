...
function handlePOST(req,res) {
	...
	if (req.url == "/api/login") {
		...
		if (req.url == "/api/reminder/update") {
			...
			var reminderIdx = findReminderByID(req.data.reminderID);
console.log('req.data.reminderID=' + req.data.reminderID);
console.log('reminderIdx=' + reminderIdx);
...
console.log('reminders[reminderIdx].invitees=' + reminders[reminderIdx].invitees.toString());
